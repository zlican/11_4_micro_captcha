...
type CallResponse struct {
	...
	Img []byte `protobuf:"bytes,1,opt,name=img,proto3" json:"img,omitempty"` //使用切片存储图片信息,用json序列化
}
...
func file_proto_getCaptcha_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_getCaptcha_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_getCaptcha_proto_msgTypes[1].Exporter = func(v any, i int) any {
